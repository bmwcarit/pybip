...
#
# Generated Wed Aug 30 11:40:07 2017 by generateDS.py version 2.28b.
# Python 2.7.6 (default, Oct 26 2016, 20:30:19)  [GCC 4.8.4]
#
# Command line options:
#   ('-o', 'ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/image_descriptor.py')
#
# Command line arguments:
#   ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/image_descriptor.xsd
#
# Command line:
#   generateDS.py -o "ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/image_descriptor.py" ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/image_descriptor.xsd
#
...
class image_descriptor(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, image_descriptor)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if image_descriptor.subclass:
            return image_descriptor.subclass(*args_, **kwargs_)
        else:
            return image_descriptor(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='', name_='image-descriptor', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('image-descriptor')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='image-descriptor')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='image-descriptor', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='image-descriptor'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='image-descriptor', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class image(GeneratedsSuper):
    ...
    def __init__(self, encoding=None, pixel=None, size=None, maxsize=None, transformation=None):
        self.original_tagname_ = None
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='image'):
        ...
        if self.transformation is not None and 'transformation' not in already_processed:
            ...
            outfile.write(' transformation=%s' % (self.gds_encode(self.gds_format_string(
                quote_attrib(self.transformation), input_name='transformation')), ))
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from image_descriptor import *\n\n')
        sys.stdout.write('import image_descriptor as model_\n\n')
