...
#
# Generated Wed Aug 30 11:41:27 2017 by generateDS.py version 2.28b.
# Python 2.7.6 (default, Oct 26 2016, 20:30:19)  [GCC 4.8.4]
#
# Command line options:
#   ('-o', 'ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/images_listing.py')
#
# Command line arguments:
#   ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/images_listing.xsd
#
# Command line:
#   generateDS.py -o "ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/images_listing.py" ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/images_listing.xsd
#
...
class images_listing(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, images_listing)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if images_listing.subclass:
            return images_listing.subclass(*args_, **kwargs_)
        else:
            return images_listing(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='', name_='images-listing', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('images-listing')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='images-listing')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='images-listing', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='images-listing'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='images-listing', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class image(GeneratedsSuper):
    ...
    def __init__(self, handle=None, created=None, modified=None):
        self.original_tagname_ = None
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'images_listing'
        rootClass = images_listing
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from images_listing import *\n\n')
        sys.stdout.write('import images_listing as model_\n\n')
