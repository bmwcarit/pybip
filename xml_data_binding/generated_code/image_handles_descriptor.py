...
#
# Generated Wed Aug 30 11:40:47 2017 by generateDS.py version 2.28b.
# Python 2.7.6 (default, Oct 26 2016, 20:30:19)  [GCC 4.8.4]
#
# Command line options:
#   ('-o', 'ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/image_handles_descriptor.py')
#
# Command line arguments:
#   ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/image_handles_descriptor.xsd
#
# Command line:
#   generateDS.py -o "ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/image_handles_descriptor.py" ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/image_handles_descriptor.xsd
#
...
class image_handles_descriptor(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, version=None, filtering_parameters=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, image_handles_descriptor)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if image_handles_descriptor.subclass:
            return image_handles_descriptor.subclass(*args_, **kwargs_)
        else:
            return image_handles_descriptor(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            self.filtering_parameters is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='image-handles-descriptor', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('image-handles-descriptor')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='image-handles-descriptor')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='image-handles-descriptor', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='image-handles-descriptor'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='image-handles-descriptor', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'image_handles_descriptor'
        rootClass = image_handles_descriptor
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from image_handles_descriptor import *\n\n')
        sys.stdout.write('import image_handles_descriptor as model_\n\n')
