...
#
# Generated Wed Aug 30 11:41:06 2017 by generateDS.py version 2.28b.
# Python 2.7.6 (default, Oct 26 2016, 20:30:19)  [GCC 4.8.4]
#
# Command line options:
#   ('-o', 'ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/image_properties.py')
#
# Command line arguments:
#   ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/image_properties.xsd
#
# Command line:
#   generateDS.py -o "ascgit142.iphonesimu/bip_profile/xml_data_binding/generated_code/image_properties.py" ascgit142.iphonesimu/bip_profile/xml_data_binding/xsd/image_properties.xsd
#
...
class image_properties(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, version=None, handle=None, friendly_name=None, native=None, variant=None, attachment=None):
        self.original_tagname_ = None
        self.version = _cast(None, version)
        self.handle = _cast(None, handle)
        self.friendly_name = _cast(None, friendly_name)
        self.native = native
        if variant is None:
            self.variant = []
        else:
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, image_properties)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if image_properties.subclass:
            return image_properties.subclass(*args_, **kwargs_)
        else:
            return image_properties(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_native(self): return self.native

    def set_native(self, native): self.native = native
    ...
    def insert_variant_at(self, index, value): self.variant.insert(index, value)

    def replace_variant_at(self, index, value): self.variant[index] = value
    ...
    def set_friendly_name(self, friendly_name): self.friendly_name = friendly_name

    def hasContent_(self):
        if (
            self.native is not None or
            self.variant or
            self.attachment
        ):
            return True
    ...
    def export(self, outfile, level, namespace_='', name_='image-properties', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('image-properties')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='image-properties')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='image-properties', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='image-properties'):
        ...
        if self.handle is not None and 'handle' not in already_processed:
            ...
            outfile.write(' handle=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.handle), input_name='handle')), ))
        if self.friendly_name is not None and 'friendly_name' not in already_processed:
            already_processed.add('friendly_name')
            outfile.write(' friendly-name=%s' %
                          (self.gds_encode(self.gds_format_string(quote_attrib(self.friendly_name), input_name='friendly-name')), ))

    def exportChildren(self, outfile, level, namespace_='', name_='image-properties', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.native is not None:
            self.native.export(outfile, level, namespace_, name_='native', pretty_print=pretty_print)
        for variant_ in self.variant:
            variant_.export(outfile, level, namespace_, name_='variant', pretty_print=pretty_print)
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'handle' not in already_processed:
            already_processed.add('handle')
            self.handle = value
        value = find_attr_value_('friendly-name', node)
        if value is not None and 'friendly-name' not in already_processed:
            already_processed.add('friendly-name')
...
# end class image_properties


class native(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, encoding=None, pixel=None, size=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, native)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if native.subclass:
            return native.subclass(*args_, **kwargs_)
        else:
            return native(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='native', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('native')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='native')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='native', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='native'):
        ...
        if self.size is not None and 'size' not in already_processed:
            ...
            outfile.write(' size=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.size), input_name='size')), ))

    def exportChildren(self, outfile, level, namespace_='', name_='native', fromsubclass_=False, pretty_print=True):
        pass
...
class variant(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='variant', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='variant', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='variant'):
        if self.encoding is not None and 'encoding' not in already_processed:
            already_processed.add('encoding')
            outfile.write(' encoding=%s' % (self.gds_encode(self.gds_format_string(
                quote_attrib(self.encoding), input_name='encoding')), ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='variant', fromsubclass_=False, pretty_print=True):
        pass
...
class attachment(GeneratedsSuper):
    ...
    def __init__(self, content_type=None, charset=None, name=None, size=None, created=None, modified=None):
        self.original_tagname_ = None
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'image_properties'
        rootClass = image_properties
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from image_properties import *\n\n')
        sys.stdout.write('import image_properties as model_\n\n')
